...
The conceptual architecture --- the HTAS/CWV split and the three backend layers --- is described in \cref{chap-description-src}. This chapter states the \textbf{rules} a developer must follow when working within that structure, and the concrete recipes for extending the application.
