...
This makes a kernel called ``CaWaQS (pixi notebook)'' appear in the VS~Code kernel picker. You then connect with \gui{Remote-SSH: Connect to Host}, open the \script{.ipynb}, select that kernel, and run the cells.
