...
\begin{figure}[H]
    ...
    \caption{Boîte de dialogue \gui{Settings} du plug-in, permettant de créer
    un nouveau projet.}
...
\begin{itemize}
    \item \textbf{L'identifiant de la première colonne d'une table attributaire commence à 0}. L'icône \includegraphics[height=0.45cm]{2_application_user_guide/fig/table.png} permet de visualiser les identifiants des champs renseignés dans la table attributaire de la résolution sélectionnée dans la liste déroulante ;
